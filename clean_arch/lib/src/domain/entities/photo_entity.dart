...
List<PhotoEntity> photoEntityFromJson(dynamic str) => List<PhotoEntity>.from(json.decode(str).map((x) => PhotoEntity.fromJson(x)));

String photoEntityToJson(List<PhotoEntity> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
