...
List<UserEntity> userEntityFromJson(dynamic str) => List<UserEntity>.from(
    (str as List<dynamic>).map((x) => UserEntity.fromJson(x)));

String userEntityToJson(List<UserEntity> data) =>
